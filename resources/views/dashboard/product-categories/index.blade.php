                ...
                <div x-data="{ openCreate: false }" class="flex flex-col lg:flex-row items-center justify-between gap-4">
                    ...
                    <form method="GET" action="#" class="w-full flex justify-end gap-1" x-data="{ openFilter: '' }">
                        ...
                        <div class="w-full lg:w-80">
                            <x-forms.input type="text" name="search" placeholder="Cari kategori produk..."
                ...
                <tbody class="divide-y divide-gray-300">
                    @forelse($productCategories as $productCategory)
                        <tr class="hover:bg-blue-50">
                            ...
                            <td class="p-2 border-r border-gray-300 whitespace-nowrap">{{ $productCategory->name }}
                            </td>
                                                ...
                                                <form method="POST"
                                                    ...
                                                    <div class="grid grid-cols-1 gap-5">
                                                        <x-forms.input name="name" label="Nama Kategori"
                                                            :value="old('name', $productCategory->name)"></x-forms.input>
                                                    </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="p-4 text-center text-gray-500">Tidak ada data kategori produk
                            </td>
                        </tr>
                    @endforelse
                </tbody>
