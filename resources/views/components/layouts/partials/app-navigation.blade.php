    ...
    <nav class="flex-1 overflow-y-auto px-4 space-y-5">
        ...
        <div class="space-y-2">
            ...
            <a href="{{ route('dashboard.product.index') }}"
                class="flex items-center space-x-3 px-4 py-2 text-gray-200 text-sm font-semibold rounded-md hover:bg-white/10 {{ Route::is('dashboard.product.*') ? 'bg-white/10 text-white' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
